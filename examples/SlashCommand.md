...
```js
const { MessageAttachment } = require('discord.js-selfbot-v14')
const fs = require('fs')
...
> [dijnie/discord.js-selfbot-v14#1055 (comment)](https://github.com/dijnie/discord.js-selfbot-v14/issues/1055#issuecomment-1949653100)
