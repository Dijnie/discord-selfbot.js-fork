...
| 2 | [Update shared structures/managers](phase-02-update-shared-files.md) | DONE | ~174 files reviewed, ~60 modified |
| 3 | [Add new v14 features](phase-03-add-v14-features.md) | DONE (deferred items noted) | ~25 new files |
